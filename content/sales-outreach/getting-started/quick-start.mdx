...
<Steps>
<Step n={1} title="Add your business mailing address." time="~3 min" path="Settings → Account → Business mailing address">
...
<Step n={2} title="Connect your sending email." time="~2 min" path="Settings → Integrations → Email Provider">
