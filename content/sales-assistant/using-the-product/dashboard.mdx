...
Your dashboard lives at [app.tenloai.com/dashboard/assistant](https://app.tenloai.com/dashboard/assistant). The left rail has four tabs — **Overview**, **Recent Leads**, **Meetings Booked**, and **Knowledge Base** — plus a **Settings** shortcut that opens the consolidated Settings hub at **Settings → Sales Assistant**. Each section below maps to one of those surfaces.
