...
<Step n={2} title="Name it and write a greeting." time="~2 min" path="Settings → Support Chatbot">
...
<Step n={5} title="Set the handoff email." time="~1 min" path="Settings → Support Chatbot → Handoff Rules">
