...
Review-request campaigns are part of **Reputation AI Growth** ($50/month CAD) and above. They were part of the base plan until the September 2026 repackaging — see [Billing & your account](/reputation-ai/reference/billing) for what moved.

Growth includes **500 campaign emails and 200 SMS a month**; Pro includes **1,000 and 500**. Going over does not fail a send: anything queued is held until the 1st, when the allowance resets. The separate **50 SMS per day** cap is checked first.
</Callout>
