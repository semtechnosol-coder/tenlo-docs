...
Found at **Settings → Account → Business contact info**. If you want replies signed personally (e.g. "Thanks again — Joe"), fill in the Owner display name field. The AI will use first-person language and reference you by name.
