...
Routing decides what happens to each review after the AI classifies it. The defaults are conservative — you can adjust everything in **Settings → Reputation AI → Routing rules**.
...
Three toggles in Settings → Reputation AI → Routing rules:
...
Legal-flag alerts route to your **Contact email** and **Contact phone** in **Settings → Account → Business contact info** — the same fields that drive the CASL sender footer on outbound emails. Set both to people who can actually act on a legal-language review (your lawyer, founder, or ops lead — not a shared inbox nobody watches). If the fields are blank, the alert falls back to Tenlo support, not you.
</Callout>
